   ...
   */
      ...
      4: [
        function (_dereq_, module, exports) {
          ...
          Grid.prototype.getNeighbors = function (node, diagonalMovement) {
            ...
            var elevation = scene.map.layers[0].data[y][x].elevation;

            // ↑
            if (this.isWalkableAt(x, y - 1)) {
              neighborsElevation = scene.map.layers[0].data[y - 1][x].elevation;
              if (Math.abs(neighborsElevation - elevation) <= 10) {
                neighbors.push(nodes[y - 1][x]);
              }
            }
            // →
            if (this.isWalkableAt(x + 1, y)) {
              neighborsElevation = scene.map.layers[0].data[y][x + 1].elevation;
              if (Math.abs(neighborsElevation - elevation) <= 10) {
            ...
            if (y % 2 == 0) {
              ...
              if (this.isWalkableAt(x - 1, y - 1)) {
                neighborsElevation =
                  scene.map.layers[0].data[y - 1][x - 1].elevation;
                if (Math.abs(neighborsElevation - elevation) <= 10) {
          ...
          AStarFinder.prototype.findPath = function (
            ...
            while (!openList.empty()) {
              ...
              for (i = 0, l = neighbors.length; i < l; ++i) {
                ...
                ng =
                  node.g + (x - node.x === 0 || y - node.y === 0 ? 1 : SQRT2);
      ...
      18: [
        function (_dereq_, module, exports) {
          ...
          JPFAlwaysMoveDiagonally.prototype.constructor =
      ...
      22: [
        function (_dereq_, module, exports) {
          ...
          var JPFMoveDiagonallyIfNoObstacles = _dereq_(
            "./JPFMoveDiagonallyIfNoObstacles"
          );
          var JPFMoveDiagonallyIfAtMostOneObstacle = _dereq_(
            "./JPFMoveDiagonallyIfAtMostOneObstacle"
          );
